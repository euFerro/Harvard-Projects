...
function LevelMaker.createMap(level)
    ...
    -- don't go above 3
    --local highestTier = math.min(3, math.floor(level / 1))
    local highestTier = 3

    -- highest color of the highest tier, no higher than 6
    --local highestColor = math.min(6, level % 5 + 3)
    local highestColor = 6
    ...
    for y = 1, numRows do
        ...
        if alternateColor1 == 6 then
            alternateTier1 = 3
        end
        if alternateColor2 == 6 then
            alternateTier2 = 3
        end
