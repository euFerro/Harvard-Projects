...
gold_medal = love.graphics.newImage('images/gold_medal.png')
silver_medal = love.graphics.newImage('images/silver_medal.png')
bronze_medal = love.graphics.newImage('images/bronze_medal.png')
